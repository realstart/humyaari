...
<div class="container">
    <table class="table-center" width="100%">
        <tr>
            <td colspan="2">
                <img width="130" src="{{ public_path() . '/images/invoice-log.jpg' }}" class="logo">
        ...
        <tr>
          <td colspan="3" style="padding-top: 30px; padding-bottom: 30px">
            <table>
              <tr class="v-top">
                <td class="bill-to">Belongs To:</td>
                <td>
        ...
        <tr>
          <td class="product-table-title" colspan="3">Invoice Description</td>
        </tr>
        <tr>
        <td colspan="3">
            <table class="product-table">
              <thead>
                <tr>
                  <th class="no">#</th>
                  <th class="name">Invoice No.</th>
                  <th class="pnr">Issue Date</th>
